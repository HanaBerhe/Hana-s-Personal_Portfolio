export const personalInfo = {
  ...
  firstName: "Hana",
  tagline: " Data Analyst | ML Engineer |Virtual Assistant |Data Entry Operator |Translator | Tutor",
  email: "hananahberhe@gmail.com",
  phone: "+251 942684581",
  location: "Addis Ababa, Ethiopia",
  linkedin: "linkedin.com/in/hana-berhe-455042333",
  github: "github.com/HanaBerhe/",
...
export const services = [
  {
    ...
    icon: "language",
    description: "Professional translation services across multiple languages including English, Amharic, Afaan Oromo, Aff-Somali, and Arabic. Specialized in technical documentation, business communications, and academic texts.",
    features: [
    ...
    stats: {
      clients: "100+",
      averageRating: "4.9/5 (client feedback)"
    }
  },
  {
    ...
    stats: {
      students: "150+",
      averageRating: "4.9/5 (student feedback)"
    }
  },
  {
    title: "Virtual Assistant",
    icon: "user-check",
    description: "Efficient virtual assistant services for scheduling, email management, research, and administrative support. Reliable, detail-oriented, and proactive assistance for professionals and businesses.",
    features: [
    ...
    stats: {
      clients: "5+",
      averageRating: "5.0/5 (client feedback)"
    }
  },
  {
    title: "Data Analysis",
    icon: "bar-chart-2",
    description: "Data analysis services including data cleaning, visualization, statistical analysis, and reporting. Transform raw data into actionable insights for business and research.",
    features: [
      "Data Cleaning",
      "Visualization",
    ...
    stats: {
      clients: "3+",
      averageRating: "4.8/5 (client feedback)"
    }
  },
  {
    title: "Data Entry",
    icon: "typewriter",
    description: "Accurate and fast data entry services for all types of documents, spreadsheets, and databases. Ensuring data integrity and confidentiality.",
    features: [
      "Document Entry",
